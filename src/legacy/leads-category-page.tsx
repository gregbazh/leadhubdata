...
// ARCHIVED 2026-07-31: the /leads/[category] subscription plan picker.
// Not routed anywhere (the live route redirects to /fl-contractors). To
// re-enable, move this back to src/app/leads/[id]/page.tsx and restore the
// subscription branch in src/app/api/checkout/route.ts.
